...
export declare type AddErrorOptions = {
    type: 'field';
    message?: any;
    value: any;
    meta: Meta;
...
export declare type ValueVisibility = {
    type: 'visible';
} | {
    type: 'hidden';
} | {
...
export declare class Context {
    ...
    constructor(fields: string[], locations: Location[], stack: ReadonlyArray<ContextItem>, optional: Optional, bail: boolean, visibility?: ValueVisibility, message?: any);
    getData(options?: {
